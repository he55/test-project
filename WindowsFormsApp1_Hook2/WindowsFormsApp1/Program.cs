...
namespace WindowsFormsApp1
{
    static class Program
    {
        ...
        public static string oriaddhook(object t, string str)
        {
            return null;
            //string cn = "Hook";
            //if (str.Contains("Window"))
       ...
       static HookManager manager2;
        ...
        static void Main()
        {
            ...
            manager.Hook(methodInfo, typeof(Program).GetMethod("addhook"), typeof(Program).GetMethod("oriaddhook"));
